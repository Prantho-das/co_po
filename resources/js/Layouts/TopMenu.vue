    ...
    <header class="z-10 py-4 bg-white shadow-md">
      <div class="container flex justify-between items-center px-6 mx-auto h-full text-purple-600 md:justify-end">
        ...
        <BreezeDropdown>
          ...
          <template #content>
            <DropdownLink  v-if="$page.props.auth.user.role" :href="route('profile.show')">
              <template #icon>
            ...
            <DropdownLink v-if="$page.props.auth.user.role" :href="route('logout')" method="post" as="button">
              <template #icon>
                <svg class="mr-3 w-4 h-4" aria-hidden="true" fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" stroke="currentColor">
             ...
             <DropdownLink v-else :href="route('student.logout')" method="post" as="button">
              <template #icon>
                <svg class="mr-3 w-4 h-4" aria-hidden="true" fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" stroke="currentColor">
                  <path d="M11 16l-4-4m0 0l4-4m-4 4h14m-5 4v1a3 3 0 01-3 3H6a3 3 0 01-3-3V7a3 3 0 013-3h7a3 3 0 013 3v1"></path>
                </svg>
