        ...
        <div class="p-4 bg-white rounded-lg shadow-xs">
            ...
            <form @submit.prevent="batchCreate" class="mb-4">
                ...
                <div class="my-4">
                    ...
                    <BreezeInput id="year" type="text" class="block w-full mt-1 p-1.5 border-2 border-rose-100"
                        v-model="form.code" required autocomplete="off" />
                    <h2 class="text-red-500" v-if="form.errors.code">{{ form.errors.code }}</h2>
                </div>
                 <div class="my-4">
                    ...
                    <select id="sessionId" v-model="form.semester"
                        ...
                        <option selected value="" disabled>Choose a Semester</option>
                        <option class="text-black" v-for="semester, i in semesters" :key="i" :value="semester.id">{{ semester.name }}</option>
...
export default {
    ...
    data() {
        return {
            form: this.$inertia.form({ name: "",code:"",credit:"",semester:"" }),
        };
    },
    methods: {
        batchCreate() {
            this.form.post(this.route("course.store"), { onSuccess: () => this.form.reset(), });
        },
    },
    props: {
       semesters:Array,
