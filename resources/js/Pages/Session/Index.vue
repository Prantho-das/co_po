            ...
            <h3 class="text-lg">Create Session Year Now</h3>
                <div class="my-4">
                    ...
                    <BreezeInput
                        ...
                        autocomplete="off"
                    />
                    <h2 class="text-red-500" v-if="form.errors.year">{{ form.errors.year }}</h2>
                </div>
                <div class="my-4">
                    <BreezeLabel for="sessionType" value="Session Type" />
                    <select id="sessionType" v-model="form.session_type"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                        <option class="text-black" selected value="" disabled>Choose a Session Type</option>
                        <option class="text-black" value="SUMMER">Summer</option>
                        <option class="text-black" value="FALL">Fall</option>
                        <option class="text-black" value="SPRING">Spring</option>
...
export default {
    ...
    methods: {
        sessionCreate() {
            this.form.post(this.route("sessions.store"),{onSuccess: () => this.form.reset(),});
        },
    },
    props: {
        sessions: Object,
