    ...
    <BreezeAuthenticatedLayout>
        ...
        <div class="p-4 bg-white rounded-lg shadow-xs">
            ...
            <form @submit.prevent="userCreate" class="mb-4">
                ...
                <div class="my-4">
                    <BreezeLabel for="department" value="Enter Department" class="text-blue-500" />
                    <BreezeInput id="department" type="text" class="block w-full mt-1 p-1.5 border-2 border-rose-100"
                        v-model="form.department" required autopomplete="off" />
